...
#### NORMALIZE NUMBERS BUT HOW TO ATTACH THEM?
they occur in the same order so you can bind them
break ended at 2:20
...
blueprint <- recipe(x  = data2,
  ...
  step_normalize(select(all_of(embed_number))) |>
  
  step_harmonic((days), cycle_size = 7) |>
